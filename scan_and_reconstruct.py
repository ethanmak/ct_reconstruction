...
def scan_and_reconstruct(
	photons, material, phantom, scale, angles, mas=10000, alpha=0.001, hounsfield=True
):
	...
	# convert to Hounsfield Units if desired (attenuation coefficients normalized against water and air)
	if hounsfield:
