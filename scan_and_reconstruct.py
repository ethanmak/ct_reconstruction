...
def scan_and_reconstruct(
	...
	mu_water = material.coeff("Water")(keVp) # the coeffs array gives attenuation coefficients in intervals of 0.001 MeV or 1.0 keV, starting from 0.0. So, the value at index 'keVp' is the the attenuation coefficient of the material for photons of energy $keVp [keVp].
	mu_air = material.coeff("Air")(keVp)
